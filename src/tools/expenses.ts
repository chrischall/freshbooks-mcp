...
export function registerExpenseTools(
  ...
  server.registerTool(
    ...
    async ({ id }) =>
      minifiedResult(
        await client.accountingGet(R.expenses.path, id, R.expenses.single),
      ),
  );
  ...
  server.registerTool(
    ...
    async ({ page, per_page }) =>
      minifiedResult(
        await client.accountingList(
          R.expense_categories.path,
          R.expense_categories.list,
          {
            page,
            perPage: per_page,
          },
    ...
    "freshbooks_create_expense",
    {
      ...
      inputSchema: z.object({
        ...
        clientid: z
          ...
          .positive()
          .optional()
          .describe("Client to rebill this expense to"),
        billable: z
          .boolean()
          .optional()
          .describe("Whether the expense is rebillable to the client"),
        fields: z
