    ...
    "freshbooks_create_project",
    {
      ...
      inputSchema: z.object({
        ...
        client_id: z
          ...
          .positive()
          .optional()
          .describe("Client this project is for"),
        project_type: z
        ...
        fixed_price: z
          ...
          .optional()
          .describe(
            "Fixed price as a decimal string, when project_type is fixed_price",
          ),
        rate: z
          .string()
          .optional()
          .describe(
            "Hourly rate as a decimal string, when project_type is hourly_rate",
          ),
    ...
    "freshbooks_create_time_entry",
    {
      ...
      inputSchema: z.object({
        duration: z
          ...
          .int()
          .nonnegative()
          .describe("Logged time in SECONDS (e.g. 3600 = 1 hour)"),
        started_at: z
          .string()
          .describe("ISO 8601 start time, e.g. 2026-08-12T09:00:00Z"),
